...
@section('page-title', 'Wilayah - Kabupaten')
@section('breadcrumb')
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover table-striped align-middle mb-0">
                <thead class="table-light"><tr><th width="50">No</th><th>Kode Wilayah</th><th>Nama Kabupaten/Kota</th><th>Provinsi Induk</th></tr></thead>
                <tbody>
                    @forelse($kabupatens as $i => $item)
                    <tr>
                        <td>{{ $kabupatens->firstItem() + $i }}</td>
