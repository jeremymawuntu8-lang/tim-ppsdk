...
@section('page-title', 'Wilayah - Kecamatan')
@section('breadcrumb')
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover table-striped align-middle mb-0">
                <thead class="table-light"><tr><th width="50">No</th><th>Kode Wilayah</th><th>Nama Kecamatan</th><th>Kabupaten Induk</th></tr></thead>
                <tbody>
                    @forelse($kecamatans as $i => $item)
                    <tr>
                        <td>{{ $kecamatans->firstItem() + $i }}</td>
